...
describe('Test Seller Auth', function () {
    describe('Test Seller Register Route', () => {
        describe('Test Seller Register Success', () => {
    ...
    describe('Test Seller Login Router', function () {
        describe('Test Seller Login Success', () => {
        ...
        describe('Test Seller Login Failed because ', () => {
        ...
        describe('Test Seller Login User Not Found', () => {
